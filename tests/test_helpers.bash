...
TROUSSEAU_TEST_STORE_AES="${TMP_DIR}/${TROUSSEAU_TEXT_FILES_PREFIX}aes_store"
TROUSSEAU_TEST_STORE_CREATE="${TMP_DIR}/${TROUSSEAU_TEST_FILES_PREFIX}create_store"
TROUSSEAU_TEST_STORE_CREATE_AES="${TMP_DIR}/${TROUSSEAU_TEXT_FILES_PREFIX}aes_create_store"
